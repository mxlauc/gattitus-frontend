...
const ImagePreloader = /* @__PURE__ */ _export_sfc(_sfc_main$11, [["ssrRender", _sfc_ssrRender$F], ["__scopeId", "data-v-3e6916df"]]);
...
const UserHeaderComponent = /* @__PURE__ */ _export_sfc(_sfc_main$10, [["ssrRender", _sfc_ssrRender$E]]);
const _sfc_main$$ = {
  components: {
    ImagePreloader
  },
...
const PetItemComponent = /* @__PURE__ */ _export_sfc(_sfc_main$$, [["ssrRender", _sfc_ssrRender$D], ["__scopeId", "data-v-0b3d99ec"]]);
const messages$2 = {
  home: "Inicio",
  profile: "Mi perfil",
  myPets: "Mis gatos",
...
const PagesList = /* @__PURE__ */ _export_sfc(_sfc_main$X, [["ssrRender", _sfc_ssrRender$C]]);
const meta$c = {
  layout: "main"
};
const __default__$e = {
...
const ReportedPostItem = /* @__PURE__ */ _export_sfc(_sfc_main$V, [["ssrRender", _sfc_ssrRender$B]]);
const _sfc_main$U = {
  components: {
    ReportedPostItem
  },
...
const ReportedPostsList = /* @__PURE__ */ _export_sfc(_sfc_main$U, [["ssrRender", _sfc_ssrRender$A]]);
const meta$b = {
  layout: "main"
};
...
const CreateReportType = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["ssrRender", _sfc_ssrRender$z]]);
const meta$a = {
  layout: "main"
};
const _sfc_main$S = {
...
const ReportTypesList = /* @__PURE__ */ _export_sfc(_sfc_main$S, [["ssrRender", _sfc_ssrRender$y]]);
const meta$9 = {
  layout: "main"
};
const __default__$d = {
...
const UsersList = /* @__PURE__ */ _export_sfc(_sfc_main$Q, [["ssrRender", _sfc_ssrRender$x]]);
const meta$8 = {
  layout: "main"
};
const _sfc_main$P = {
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["ssrRender", _sfc_ssrRender$w], ["__scopeId", "data-v-41ef62b3"]]);
const _sfc_main$O = {
  components: {
...
const DeletePostDialog = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["ssrRender", _sfc_ssrRender$v]]);
const _sfc_main$N = {
  setup() {
    const mainStore = useMainStore();
    return {
...
const PetIconItem = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["ssrRender", _sfc_ssrRender$t]]);
const _sfc_main$K = {
...
const PetIconList = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["ssrRender", _sfc_ssrRender$s]]);
const _sfc_main$J = {
  components: {
    CustomModal: __nuxt_component_0$2,
    ImagePreloader
...
const ShowReactionsDialog = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["ssrRender", _sfc_ssrRender$r]]);
const _sfc_main$I = {
  components: {
    ShowReactionsDialog
  },
...
const ReactAndCommentButtons = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["ssrRender", _sfc_ssrRender$q]]);
const _sfc_main$H = {
  components: {
    CustomModal: __nuxt_component_0$2
  },
...
const DeleteCommentDialog = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["ssrRender", _sfc_ssrRender$p]]);
const _sfc_main$G = {
  components: {
    CustomModal: __nuxt_component_0$2
  },
...
const _sfc_main$D = /* @__PURE__ */ Object.assign(__default__$a, {
  ...
  async setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(serverRenderer.exports.ssrRenderComponent(vue_cjs_prod.unref(Popper), {
        arrow: "",
        ...
        content: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="contenedorGifs" data-v-386a9f84${_scopeId}><div class="contenedorInput" data-v-386a9f84${_scopeId}><input type="text"${serverRenderer.exports.ssrRenderAttr("placeholder", vue_cjs_prod.unref(t)("search"))} data-v-386a9f84${_scopeId}></div><div style="${serverRenderer.exports.ssrRenderStyle({ "height": "344px", "overflow": "auto" })}" data-v-386a9f84${_scopeId}><div class="row g-0"${serverRenderer.exports.ssrRenderAttr("id", ["masonry-gifs-row" + __props.postId])} data-v-386a9f84${_scopeId}><!--[-->`);
            serverRenderer.exports.ssrRenderList(_ctx.gifs, (gif) => {
              _push2(`<div class="col-6" style="${serverRenderer.exports.ssrRenderStyle({ aspectRatio: gif.media[0].nanogif.dims[0] / gif.media[0].nanogif.dims[1] })}" data-v-386a9f84${_scopeId}></div>`);
            });
            _push2(`<!--]--></div></div></div>`);
          } else {
            return [
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="p-1" viewBox="0 0 16 16" data-v-386a9f84${_scopeId}><path d="M2.5 1A1.5 1.5 0 0 0 1 2.5v11A1.5 1.5 0 0 0 2.5 15h6.086a1.5 1.5 0 0 0 1.06-.44l4.915-4.914A1.5 1.5 0 0 0 15 8.586V2.5A1.5 1.5 0 0 0 13.5 1h-11zM2 2.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 .5.5V8H9.5A1.5 1.5 0 0 0 8 9.5V14H2.5a.5.5 0 0 1-.5-.5v-11zm7 11.293V9.5a.5.5 0 0 1 .5-.5h4.293L9 13.793z" data-v-386a9f84${_scopeId}></path></svg>`);
          } else {
            return [
              (vue_cjs_prod.openBlock(), vue_cjs_prod.createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
      ...
      _push(`<p data-v-386a9f84>gifpiker comp</p><!--]-->`);
    };
  }
});
...
const GifPickerComponent = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["__scopeId", "data-v-386a9f84"]]);
const __default__$9 = {
  components: {
    GifPickerComponent,
    ImagePreloader
...
const _sfc_main$C = /* @__PURE__ */ Object.assign(__default__$9, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(_attrs)} data-v-a265282e><div class="row g-0 border-top pt-1" data-v-a265282e>`);
      if (_ctx.gifSeleccionado) {
        _push(`<div class="col-auto position-relative mx-auto" data-v-a265282e><img${serverRenderer.exports.ssrRenderAttr("src", _ctx.gifSeleccionado)} style="${serverRenderer.exports.ssrRenderStyle({ "height": "100px", "border-radius": "5px" })}" data-v-a265282e><button type="button" class="btn-close bg-white shadow position-absolute top-0 end-0 m-1 p-2 rounded-circle" aria-label="Close" data-v-a265282e></button></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (vue_cjs_prod.unref(mainStore).userLogged) {
        _push(`<div class="row g-0 pb-2 pt-1" data-v-a265282e><div class="col col-auto" data-v-a265282e>`);
        _push(serverRenderer.exports.ssrRenderComponent(ImagePreloader, {
          image: (_a = vue_cjs_prod.unref(mainStore).userLogged) == null ? void 0 : _a.image,
          aspect: "1",
          class: "imagenUsuario shadow"
        }, null, _parent));
        _push(`</div><div class="col ms-2" data-v-a265282e><div class="row g-0 contenedorTextarea" data-v-a265282e><div class="col" data-v-a265282e><span class="textarea text-break" contenteditable data-v-a265282e></span></div><div class="col col-auto guide-4" style="${serverRenderer.exports.ssrRenderStyle({ "color": "#f50" })}" data-v-a265282e>`);
        _push(serverRenderer.exports.ssrRenderComponent(GifPickerComponent, { "post-id": __props.postId }, null, _parent));
        _push(`<svg class="pe-2" fill="currentColor" role="button" width="35" height="35" viewBox="0 0 24 24" data-v-a265282e><path d="M16.6915026,12.4744748 L3.50612381,13.2599618 C3.19218622,13.2599618 3.03521743,13.4170592 3.03521743,13.5741566 L1.15159189,20.0151496 C0.8376543,20.8006365 0.99,21.89 1.77946707,22.52 C2.41,22.99 3.50612381,23.1 4.13399899,22.8429026 L21.714504,14.0454487 C22.6563168,13.5741566 23.1272231,12.6315722 22.9702544,11.6889879 C22.8132856,11.0605983 22.3423792,10.4322088 21.714504,10.118014 L4.13399899,1.16346272 C3.34915502,0.9 2.40734225,1.00636533 1.77946707,1.4776575 C0.994623095,2.10604706 0.8376543,3.0486314 1.15159189,3.99121575 L3.03521743,10.4322088 C3.03521743,10.5893061 3.34915502,10.7464035 3.50612381,10.7464035 L16.6915026,11.5318905 C16.6915026,11.5318905 17.1624089,11.5318905 17.1624089,12.0031827 C17.1624089,12.4744748 16.6915026,12.4744748 16.6915026,12.4744748 Z" fill-rule="evenodd" stroke="none" data-v-a265282e></path></svg></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const NewComment = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["__scopeId", "data-v-a265282e"]]);
const _sfc_main$B = {
  components: {
    ComentarioComponent,
    NewComment

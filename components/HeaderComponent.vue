<template>
    <div class="py-2 px-0 pe-1 pe-sm-4 container-xxl">
        <!--px-1 px-sm-4-->
        <div class="row g-0">
            ...
            <div
                class="col-auto d-none d-xl-block text-center"
                style="width: 260px;">
                <NuxtLink
                    to="/"
            ...
            <div class="col-auto ms-auto">
                <div v-if="mainStore.userLogged">
                    ...
                    <DisplayOnMounted>
                        ...
                        <template #content>
                            <div class="list-group list-group-flush">
                                <NuxtLink to="/help" class="list-group-item list-group-item-action">
        ...
        <CreatePetComponent v-if="show_create_pet"
         @close="show_create_pet=false"></CreatePetComponent>
    </div>
</template>
<script setup>
